...
def get_testcases_info(chapter_file_name, chapter):
    ...
    for testcase in testcases:
        ...
        id = testcase.get('id')
        link = f"https://github.com/OWASP/owasp-mstg/blob/master/Document/{chapter_file_name}#{id}"
        ...
        testcases_info.append(TestCase(id, link, title, mstg_ids, tools, overview))
